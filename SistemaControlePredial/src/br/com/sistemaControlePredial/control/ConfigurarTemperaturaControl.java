...
public class ConfigurarTemperaturaControl extends ConfigurarTemperaturaView {
	...
	/*
	 * verifica se o ar-condionado deve ser ligado ou não. O ar-condicionado
	 * será ligado se a temperatura ambiente atual for maior que cadastrada
	 * caso contrario ele deve ser desligado
	 */
	...
	/*
	 * verifica se podemos ligar o ar-condicionado. Só podemos ligar ou
	 * desligar o ar, entre outras situações, se o horario da maquina estiver
	 * entre o seu horario de funcinamento
	 */
